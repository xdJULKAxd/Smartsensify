...
export function Sidebar({isSidebarVisible}) {
    ...
    <div><i className="fa-solid fa-envelope"></i><a href="contact.asp">Powiadomienia</a></div>
    <div><i className="fa-solid fa-heart"></i><a href="about.asp">Ocena aplikacji</a></div>
    </div>
    <div className="bottom-link">
    <div><i className="fa-solid fa-gears"></i><a href="about.asp">Ustawienia</a></div>
        </div>
      </div>
    );
  }
